...
class Carousel extends Component {
  constructor(props) {
    ...
    startAt = Array.isArray(this.props.children)
      ? strictIndexing && startAt > childrenLength - 1
        ? childrenLength - 1
        : startAt
      : 0;
  ...
  render() {
    ...
    const navButtonsAlwaysInvisible =
      this.props.navButtonsAlwaysInvisible !== undefined ? this.props.navButtonsAlwaysInvisible : false;
          ...
          {!navButtonsAlwaysInvisible && (
            <div className={`${buttonWrapperCssClassValue} ${classes.prev}`}>
              <ButtonBase
                ...
                onClick={this.prev}
                aria-label="Previous"
                style={{ backgroundColor: this.props.navigationButtonColor }}
              >
                <NavigateBeforeIcon />
              </ButtonBase>
            </div>
